...
fun main() {
    ...
    val лік1 = Ліки("Лік1", "Тамбл", "Таблетки", "ФармЕсперт", "2023-01-01", "2024-03-01", "52.0", "true")
    val лік2 = Ліки("Лік2", "Німомед", "Капсули", "МЕДІАФарм", "2023-04-03", "2026-05-01", "128.8", "false")
    val лік3 = Ліки("Лік3", "SuropOne", "Суспензія", "FARMA", "2021-06-06", "2024-12-01", "258.7", "false")
    val лік4 = Ліки("Лік4", "Синусеп", "Краплі", "ФармЕксперт", "2022-09-14", "2026-09-14", "370.0", "false")
